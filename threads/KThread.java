...
public class KThread {
    ...
    public static void finish() {
        ...
        while((threadJoined = currentThread.joinQueue.nextThread()) != null)
            threadJoined.ready();
    ...
    public void join() {
        ...
        /*We add the current thread (the one who called the join of this thread)
         *to the joinQueue, later, when the thread finish, we will put back to
...
/* aqui coloco otra prueba que use para corroborar la efectividad del transfer priority */

//public static void selfTest(){
/* try to change these numbers only, represents the priorities
* of t1, t2 and t3, the default values is 5, 6 and 7 respectively
*/
